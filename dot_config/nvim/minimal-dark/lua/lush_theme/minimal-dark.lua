...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    CursorLineNr { bg = secondaryBlack, fg = normalText },  -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.

    Directory { fg = normalText },                          -- Directory names (and other special names in listings)
    ...
    VertSplit { fg = secondaryBlack },             -- Column separating vertically split windows
    -- Folded         { }, -- Line used for closed folds
    -- FoldColumn     { }, -- 'foldcolumn'
    SignColumn { fg = normalText }, -- Column where |signs| are displayed
    ...
    -- Search { bg = secondaryBlack },         -- Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
    ...
    Whitespace { fg = secondaryBlack }, -- "nbsp", "space", "tab" and "trail" in 'listchars'
